...
public final class SMSRequest {
    ...
    public static SMSRequest from(String rawRequest,Context context){
        Logger logger = WebLog.getLogger(context);
        ...
        try {
            ...
            logger.info("request.mType:" + request.mType);
            logger.info("request.mContent:" + request.mContent);
            return request;
